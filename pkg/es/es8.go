...
func (es *V8) NewScroll(index string, option *ScrollOption) (*ScrollResult, error) {
...
func (es *V8) BulkInsert(index string, hitDocs []*Doc) error {
	var buf bytes.Buffer
...
func (es *V8) BulkUpdate(index string, hitDocs []*Doc) error {
	var buf bytes.Buffer
...
func (es *V8) BulkDelete(index string, hitDocs []*Doc) error {
	var buf bytes.Buffer
